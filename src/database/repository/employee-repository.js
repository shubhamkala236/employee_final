...
async UserUpdateDetails(Id,newUserData){
    ...
    async AddSalary({Basic,HRA,Convince,LTA,SPL,PF_Employee,PF_Employer,Id,ESIC_Employer,ESIC_Employee,TDS,MEDICAL,PF_NUMBER,ESIC_NUMBER,LWF_Employer}){
        try{    
            console.log("data");
            ...
            if(existingUser){
                const updateUser = await SalaryDetailsModel.findOneAndUpdate({ Employee_id:Id },updateobj);
                return updateUser;
            }


            const salary = new SalaryDetailsModel({
                Basic,HRA,Convince,LTA,SPL,PF_Employee,PF_Employer,Employee_id:Id,ESIC_Employer,ESIC_Employee,TDS,MEDICAL,PF_NUMBER,ESIC_NUMBER,LWF_Employer
            })
